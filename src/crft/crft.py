...
from .crft_module import LocalFeatureTransformer, FineProcess, CoarseMatching, FineMatching
from torch.utils.checkpoint import checkpoint

class CRFT(nn.Module):
    ...
    def forward(self, data):
        ...
        self.coarse_matching(feat_c0, feat_c1, data, mask_c0, mask_c1)
        
        # get coarse flow for fine_process
        coarse_flow = data.get('flow_c', None)
